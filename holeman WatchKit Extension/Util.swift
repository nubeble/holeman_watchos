...
struct Util {
    ...
    static func revokeToken(_ token: String) {
        let url = "https://asia-northeast1-holeman-4070a.cloudfunctions.net/revoke_token"
